# 🛡️ RecoveryAI - GenAI Recovery & Prevention Platform
...
1. **Zero-Typing Check-In**: Open Tab 1, click the chip `"I'm feeling stressed and want to drink"`, click **Run Check-In Analysis**. Observe the real-time Gemini output with risk level, trigger detection, and micro-actions.
2. **Instant Emergency Support**: Click the big red **"🚨 NEED HELP NOW"** button in the header. Watch Gemini generate an immediate coping script, step-by-step grounding actions, and an animated 4-7-8 breathing circle.
3. **Safety Plan**: Open Tab 3, select `"Loneliness & Social Isolation"`, click **Generate Safety Plan**. Review structured prevention techniques and healthy alternatives.
4. **Recovery Education**: Open Tab 4, click `"Explain My Cravings"`. Demonstrate how Gemini breaks down complex neuroscience into compassionate, simple language.
